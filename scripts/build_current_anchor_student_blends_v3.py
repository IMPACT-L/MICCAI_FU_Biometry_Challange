...
OUT_ROOT = REPO / "output/submissions/current_anchor_student_blends_v3"

BASE = {"A4C": 0.10, "AOP": 0.08, "HC": 0.20, "IVC": 0.18, "PLAX": 0.16, "PSAX": 0.10}
CANDIDATES = {
    "a4c_lower": {**BASE, "A4C": 0.06},
    "a4c_higher": {**BASE, "A4C": 0.14},
    "psax_lower": {**BASE, "PSAX": 0.06},
    "psax_higher": {**BASE, "PSAX": 0.14},
    "plax_lower": {**BASE, "PLAX": 0.10},
    "plax_higher": {**BASE, "PLAX": 0.22},
    "a4c_psax_higher": {**BASE, "A4C": 0.14, "PSAX": 0.14},
    "a4c_higher_psax_lower": {**BASE, "A4C": 0.14, "PSAX": 0.06},
    "a4c_lower_psax_higher": {**BASE, "A4C": 0.06, "PSAX": 0.14},
}
