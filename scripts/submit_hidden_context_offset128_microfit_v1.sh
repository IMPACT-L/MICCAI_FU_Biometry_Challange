...
RUN_DIR="${1:-output/runs/dinov3_vitb_hidden_context_offset128_microfit_v1_seed42}"
SUBMISSION_DIR="${2:-output/submissions/dinov3_vitb_hidden_context_offset128_microfit_v1_seed42}"
