...
ROI_CKPT="${2:-output/runs/dinov3_vitb_hidden_context_roi_zoom_jitter_v2_seed42/checkpoints/best_model.pth}"
SUBMIT_DIR="${3:-output/submissions/dinov3_vitb_hidden_context_two_stage_roi_zoom_jitter_safe_v2_seed42}"
