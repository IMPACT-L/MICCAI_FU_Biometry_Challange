...
OUT_ROOT = REPO / "output/submissions/current_anchor_student_blends_v1"


CANDIDATES = {
    "hcivcplax_light": {"HC": 0.18, "IVC": 0.16, "PLAX": 0.16},
    "hcivcplax_mid": {"HC": 0.28, "IVC": 0.24, "PLAX": 0.22},
    "all_hard_light": {"A4C": 0.10, "AOP": 0.08, "HC": 0.20, "IVC": 0.18, "PLAX": 0.16, "PSAX": 0.10},
    "hc_only_mid": {"HC": 0.35},
    "a4c_hc_ivc_light": {"A4C": 0.10, "HC": 0.24, "IVC": 0.20},
}
