...
RUN_DIR="${1:-output/runs/dinov3_vitb_taskfpn_hidden_context_pseudo_hardtasks_round2_v1_seed42}"
SUBMISSION_DIR="${2:-output/submissions/dinov3_vitb_taskfpn_hidden_context_pseudo_hardtasks_round2_v1_seed42}"
