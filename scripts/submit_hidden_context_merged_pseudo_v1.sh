...
RUN_DIR="${1:-output/runs/dinov3_vitb_taskfpn_hidden_context_merged_pseudo_v1_seed42}"
SUBMISSION_DIR="${2:-output/submissions/dinov3_vitb_taskfpn_hidden_context_merged_pseudo_v1_seed42}"
