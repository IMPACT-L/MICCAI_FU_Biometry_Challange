...
OUTPUT_DIR="${1:-output/runs/dinov3_vitb_taskfpn_hidden_context_pseudo_hardtasks_tta_v2_seed42}"
BASE_CKPT="${2:-output/runs/dinov3_vitb_taskfpn_hidden_context_pseudo_hardtasks_bn_v1_seed42/checkpoints/best_model.pth}"
SUBMISSION_JSON="${3:-output/submissions/dinov3_vitb_taskfpn_hidden_context_pseudo_hardtasks_bn_tta_teacher_v2_seed42/regression_predictions.json}"
PSEUDO_ROOT="${4:-output/pseudo_datasets/dinov3_vitb_taskfpn_hidden_context_pseudo_hardtasks_bn_tta_teacher_v2_seed42}"
SEED="${5:-42}"
