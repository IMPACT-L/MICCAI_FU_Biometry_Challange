...
OUTPUT_DIR="${1:-output/runs/dinov3_vitb_taskfpn_hidden_context_pseudo_hardtasks_headonly_v1_seed42}"
...
python baseline/train.py \
  ...
  --measurement-task-weights FA=1.00,HC=1.20,IVC=1.55,PLAX=0.80 \
  --dataset-loss-weight 0.0 \
  --femur-shaft-loss-weight 0.0 \
  --fugc-segment-loss-weight 0.0 \
  --ivc-band-loss-weight 0.08 \
  --task-loss-weights A4C=1.05,FA=1.10,HC=1.30,IVC=1.40,PLAX=1.10 \
  --sampler-task-weights A4C=1.05,FA=1.10,HC=1.30,IVC=1.40,PLAX=1.10 \
  --ema-decay 0.999 \
