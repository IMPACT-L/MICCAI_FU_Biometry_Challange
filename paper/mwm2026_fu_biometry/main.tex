...
\begin{figure}[t]
  ...
  \caption{Method overview of the proposed multi-domain ultrasound biometry model. A shared DINOv3 encoder is followed by task-specific feature pyramids, task-conditioned heatmap decoding, soft-argmax coordinate extraction, learned offset refinement, and measurement derivation, with canonical ordering enforced for paired-landmark tasks.}
  \label{fig:overview}
\end{figure}
